...
NCountry = {
	...
	DISHONOURED_ALLIANCE_DURATION = 1800,
        ...
        --NOTE: CHANGE IN MOD
	CALL_ALLY_DECLINE_PRESTIGE_PENALTY = -10.0,		-- Prestige penalty for declining call for arms
...
NMilitary = {
	...
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = 0,	-- Multiplier for morale damage taken by backrow
...
NGovernment = {
	...
	GOVERNMENT_REFORM_COST_CENTRALIZE_STATE = 0,
	CENTRALIZE_STATE_ADM_COST = 150,
